...
data SumPolynomial      n = SumPolynomial (Polynomial n) (Var n)           deriving (Show, Eq)
data SumClampPolynomial n = SumClampPolynomial (ClampPolynomial n) (Var n) deriving (Show, Eq)
